...
// == command Ebi filter traces empty == 
	...
	public static org.deckfour.xes.model.XLog Ebi_filter_traces_empty__as__event_log__to__XLog(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public org.deckfour.xes.model.XLog prom_Ebi_filter_traces_empty__as__event_log__to__XLog(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_filter_traces_empty__as__event_log__to__XLog(context, input_0);
	}
...
// == command Ebi filter traces event activity == 
	...
	public static org.deckfour.xes.model.XLog Ebi_filter_traces_event_activity__as__event_log__to__XLog(PluginContext context, org.deckfour.xes.model.XLog input_0, String input_1, String input_2) throws Exception {
	...
	@Plugin(
		name = "Remove all traces that do not have event(s) as specified. (input: XLog; output: XLog)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "XLog" }, 
		returnTypes = { org.deckfour.xes.model.XLog.class },
		parameterLabels = { "XLog" },
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Remove all traces that do not have event(s) as specified. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public org.deckfour.xes.model.XLog prom_Ebi_filter_traces_event_activity__as__event_log__to__XLog(UIPluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		EbiDialog dialog = new EbiDialog();
		dialog.add_input(org.processmining.ebi.objects.EbiString.create_input_panel("event selector"));
		dialog.add_input(org.processmining.ebi.objects.EbiString.create_input_panel("the activity the filter targets"));
		InteractionResult result = context.showWizard("Remove all traces that do not have event(s) as specified.", true, true, dialog);
		...
		return Ebi_filter_traces_event_activity__as__event_log__to__XLog(context, input_0, input_1, input_2);
	}
...
// == command Ebi filter traces length == 
	...
	public static org.deckfour.xes.model.XLog Ebi_filter_traces_length__as__event_log__to__XLog(PluginContext context, org.deckfour.xes.model.XLog input_0, String input_1, Integer input_2) throws Exception {
	...
	@Plugin(
		name = "Remove traces that do not have a given length. (input: XLog; output: XLog)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "XLog" }, 
		returnTypes = { org.deckfour.xes.model.XLog.class },
		parameterLabels = { "XLog" },
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Remove traces that do not have a given length. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public org.deckfour.xes.model.XLog prom_Ebi_filter_traces_length__as__event_log__to__XLog(UIPluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		EbiDialog dialog = new EbiDialog();
		dialog.add_input(org.processmining.ebi.objects.EbiString.create_input_panel("the value"));
		dialog.add_input(org.processmining.ebi.objects.EbiInteger.create_input_panel("the log"));
		InteractionResult result = context.showWizard("Remove traces that do not have a given length.", true, true, dialog);
		...
		String input_1 = dialog.get_parameter_String(0);
		Integer input_2 = dialog.get_parameter_Integer(1);
		return Ebi_filter_traces_length__as__event_log__to__XLog(context, input_0, input_1, input_2);
	}

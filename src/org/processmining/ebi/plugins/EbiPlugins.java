...
// == command Ebi discover-non-stochastic directly-follows-graph == 

	public static org.processmining.models.graphbased.directed.petrinet.Petrinet Ebi_discover_non_stochastic_directly_follows_graph__as__labelled_Petri_net__to__PetriNet(PluginContext context, org.deckfour.xes.model.XLog input_0, org.apache.commons.math3.fraction.BigFraction input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover-non-stochastic directly-follows-graph", ".lpn", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiFraction.toEbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiLabelledPetriNet.EbiString2Petrinet(context, result);
	}
	...
	@Plugin(
		...
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Discover a directly follows graph with at least the given fitness. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public org.processmining.models.graphbased.directed.petrinet.Petrinet prom_Ebi_discover_non_stochastic_directly_follows_graph__as__labelled_Petri_net__to__PetriNet(UIPluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		EbiDialog dialog = new EbiDialog();
		dialog.add_input(org.processmining.ebi.objects.EbiFraction.create_input_panel("The minimum fitness of the resulting model."));
		InteractionResult result = context.showWizard("Discover a directly follows graph.", true, true, dialog);
		...
		org.apache.commons.math3.fraction.BigFraction input_1 = dialog.get_parameter_org.apache.commons.math3.fraction.BigFraction(0);
		return Ebi_discover_non_stochastic_directly_follows_graph__as__labelled_Petri_net__to__PetriNet(context, input_0, input_1);
	}

	public static org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights Ebi_discover_non_stochastic_directly_follows_graph__as__stochastic_labelled_Petri_net__to__StochasticLabelledPetriNet(PluginContext context, org.deckfour.xes.model.XLog input_0, org.apache.commons.math3.fraction.BigFraction input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover-non-stochastic directly-follows-graph", ".slpn", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiFraction.toEbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiStochasticLabelledPetriNet.EbiString2StochasticLabelledPetriNet(context, result);
	}
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights prom_Ebi_discover_non_stochastic_directly_follows_graph__as__stochastic_labelled_Petri_net__to__StochasticLabelledPetriNet(UIPluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		EbiDialog dialog = new EbiDialog();
		dialog.add_input(org.processmining.ebi.objects.EbiFraction.create_input_panel("The minimum fitness of the resulting model."));
		InteractionResult result = context.showWizard("Discover a directly follows graph.", true, true, dialog);
		...
		org.apache.commons.math3.fraction.BigFraction input_1 = dialog.get_parameter_org.apache.commons.math3.fraction.BigFraction(0);
		return Ebi_discover_non_stochastic_directly_follows_graph__as__stochastic_labelled_Petri_net__to__StochasticLabelledPetriNet(context, input_0, input_1);
	}

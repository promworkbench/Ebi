...
// == command Ebi analyse entropy == 
	...
	public static org.processmining.ebi.objects.EbiLogDiv Ebi_analyse_entropy__as__logdiv__to__logdiv(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi analyse entropy", ".logdiv", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiLogDiv.fromEbiString(context, result);
	}

	@Plugin(
		name = "Computes the entropy of the object. (input: XLog; output: logdiv)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "logdiv" }, 
		...
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Computes the entropy of the object. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public org.processmining.ebi.objects.EbiLogDiv prom_Ebi_analyse_entropy__as__logdiv__to__logdiv(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_analyse_entropy__as__logdiv__to__logdiv(context, input_0);
	}
...
// == command Ebi conformance gain-precision == 
	...
	public static org.apache.commons.math3.fraction.BigFraction Ebi_conformance_gain_precision__as__fraction__to__fraction(PluginContext context, org.deckfour.xes.model.XLog input_0, org.deckfour.xes.model.XLog input_1, org.apache.commons.math3.fraction.BigFraction input_2) throws Exception {
		String result = CallEbi.call_ebi("Ebi conformance gain-precision", ".frac", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_1), org.processmining.ebi.objects.EbiFraction.toEbiString(context, input_2)});
		return org.processmining.ebi.objects.EbiFraction.fromEbiString(context, result);
	}

	@Plugin(
		name = "Compute gain-based precision. (input: XLog, XLog; output: fraction)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "fraction" }, 
		returnTypes = { org.apache.commons.math3.fraction.BigFraction.class },
		parameterLabels = { "XLog", "XLog" },
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Compute gain-based precision for a finite stochastic language and an SDFA. If the SDFA supports less than two traces, set lambda to a small non-zero value. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public org.apache.commons.math3.fraction.BigFraction prom_Ebi_conformance_gain_precision__as__fraction__to__fraction(UIPluginContext context, org.deckfour.xes.model.XLog input_0, org.deckfour.xes.model.XLog input_1) throws Exception {
		EbiDialog dialog = new EbiDialog();
		dialog.add_input(org.processmining.ebi.objects.EbiFraction.create_input_panel("The smoothing parameter. If the SDFA supports less than two traces, set this to a small value."));
		InteractionResult result = context.showWizard("Compute gain-based precision.", true, true, dialog);

		if (result != InteractionResult.FINISHED) {
			context.getFutureResult(0).cancel(false);
			return null;
}
		org.apache.commons.math3.fraction.BigFraction input_2 = dialog.get_parameter_org_apache_commons_math3_fraction_BigFraction(0);
		return Ebi_conformance_gain_precision__as__fraction__to__fraction(context, input_0, input_1, input_2);
	}
...
// == command Ebi conformance gain-recall == 
	...
	public static org.apache.commons.math3.fraction.BigFraction Ebi_conformance_gain_recall__as__fraction__to__fraction(PluginContext context, org.deckfour.xes.model.XLog input_0, org.deckfour.xes.model.XLog input_1, org.apache.commons.math3.fraction.BigFraction input_2) throws Exception {
		String result = CallEbi.call_ebi("Ebi conformance gain-recall", ".frac", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_1), org.processmining.ebi.objects.EbiFraction.toEbiString(context, input_2)});
		return org.processmining.ebi.objects.EbiFraction.fromEbiString(context, result);
	}

	@Plugin(
		name = "Compute gain-based recall. (input: XLog, XLog; output: fraction)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "fraction" }, 
		returnTypes = { org.apache.commons.math3.fraction.BigFraction.class },
		parameterLabels = { "XLog", "XLog" },
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Compute gain-based recall for a finite stochastic language and an SDFA. If the SDFA supports less than two traces, set lambda to a small non-zero value. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public org.apache.commons.math3.fraction.BigFraction prom_Ebi_conformance_gain_recall__as__fraction__to__fraction(UIPluginContext context, org.deckfour.xes.model.XLog input_0, org.deckfour.xes.model.XLog input_1) throws Exception {
		EbiDialog dialog = new EbiDialog();
		dialog.add_input(org.processmining.ebi.objects.EbiFraction.create_input_panel("The smoothing parameter. If the SDFA supports less than two traces, set this to a small value."));
		InteractionResult result = context.showWizard("Compute gain-based recall.", true, true, dialog);
		...
		org.apache.commons.math3.fraction.BigFraction input_2 = dialog.get_parameter_org_apache_commons_math3_fraction_BigFraction(0);
		return Ebi_conformance_gain_recall__as__fraction__to__fraction(context, input_0, input_1, input_2);
	}

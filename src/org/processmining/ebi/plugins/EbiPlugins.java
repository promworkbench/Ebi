...
// == command Ebi analyse-non-stochastic any-traces == 
	...
	@Plugin(
		...
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Compute whether the model has any traces.
        ...
        The computation may not terminate if the model is unbounded. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
...
// == command Ebi analyse-non-stochastic bounded == 
	...
	@Plugin(
		...
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Compute whether the model has a bounded state space. 
        For Petri nets, a coverability graph is computed~\cite{esparza2019petri}. 
        For other types of models, `true' is returned. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
...
// == command Ebi test permutation-test == 
...
// == command Ebi visualise graph == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_visualise_graph__as__SVG__to__svg(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_visualise_graph__as__SVG__to__svg(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		return Ebi_visualise_graph__as__SVG__to__svg(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_visualise_graph__as__SVG__to__svg(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_visualise_graph__as__SVG__to__svg(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		return Ebi_visualise_graph__as__SVG__to__svg(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_visualise_graph__as__SVG__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_visualise_graph__as__SVG__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_visualise_graph__as__SVG__to__svg(context, input_0);
	}

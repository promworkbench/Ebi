...
// == command Ebi analyse-non-stochastic any-traces == 
	...
	public static boolean Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has any traces. (input: process tree; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has any traces. (input: AcceptingPetriNet; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		return Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has any traces. (input: XLog; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has any traces. (input: StochasticLabelledPetriNet; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		return Ebi_analyse_non_stochastic_any_traces__as__boolean__to__bool(context, input_0);
	}
...
// == command Ebi analyse-non-stochastic bounded == 
	...
	public static boolean Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has a bounded state space. (input: process tree; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "process tree" },
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Compute whether the model has a bounded state space.          For Petri nets, a coverability graph is computed~\cite{esparza2019petri}.          For other types of models, `true' is returned. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has a bounded state space. (input: AcceptingPetriNet; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "AcceptingPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		return Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has a bounded state space. (input: StochasticLabelledPetriNet; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "StochasticLabelledPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		return Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has a bounded state space. (input: XLog; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_analyse_non_stochastic_bounded__as__boolean__to__bool(context, input_0);
	}
...
// == command Ebi analyse-non-stochastic infinitely-many-traces == 
	...
	public static boolean Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has infinitely many traces. (input: XLog; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has infinitely many traces. (input: StochasticLabelledPetriNet; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "StochasticLabelledPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		return Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has infinitely many traces. (input: process tree; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "process tree" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
	...
	@Plugin(
		name = "Compute whether the model has infinitely many traces. (input: AcceptingPetriNet; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "AcceptingPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		return Ebi_analyse_non_stochastic_infinitely_many_traces__as__boolean__to__bool(context, input_0);
	}
...
// == command Ebi convert labelled-petri-net == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi convert labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiStochasticLabelledPetriNet.StochasticLabelledPetriNet2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Convert an object to a labelled Petri net. (input: StochasticLabelledPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		return Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi convert labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiProcessTree.EfficientTree2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Convert an object to a labelled Petri net. (input: process tree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "process tree" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi convert labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiLabelledPetriNet.AcceptingPetriNet2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Convert an object to a labelled Petri net. (input: AcceptingPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "AcceptingPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		return Ebi_convert_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi convert stochastic-finite-deterministic-automaton == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_convert_stochastic_finite_deterministic_automaton__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi convert stochastic-finite-deterministic-automaton", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Convert an object to a stochastic deterministic finite automaton. (input: XLog; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_convert_stochastic_finite_deterministic_automaton__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_convert_stochastic_finite_deterministic_automaton__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi discover alignments == 
	...
	@Plugin(
		name = "Give each transition a weight that matches the aligned occurrences of its label. (input: XLog, process tree; output: PetriNet)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "PetriNet" }, 
		returnTypes = { org.processmining.models.graphbased.directed.petrinet.Petrinet.class },
	...
	@Plugin(
		name = "Give each transition a weight that matches the aligned occurrences of its label. (input: XLog, process tree; output: StochasticLabelledPetriNet)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "StochasticLabelledPetriNet" }, 
		returnTypes = { org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights.class },
		parameterLabels = { "XLog", "process tree" },
	...
	public static com.kitfox.svg.SVGDiagram Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover alignments", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiStochasticLabelledPetriNet.StochasticLabelledPetriNet2EbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight that matches the aligned occurrences of its label. (input: XLog, StochasticLabelledPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "StochasticLabelledPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_1) throws Exception {
		return Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(context, input_0, input_1);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover alignments", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiLabelledPetriNet.AcceptingPetriNet2EbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight that matches the aligned occurrences of its label. (input: XLog, AcceptingPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "AcceptingPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_1) throws Exception {
		return Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(context, input_0, input_1);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover alignments", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiProcessTree.EfficientTree2EbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight that matches the aligned occurrences of its label. (input: XLog, process tree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "process tree" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_1) throws Exception {
		return Ebi_discover_alignments__as__scalable_vector_graphics__to__svg(context, input_0, input_1);
	}
...
// == command Ebi discover directly-follows-graph == 
	...
	public org.processmining.models.graphbased.directed.petrinet.Petrinet prom_Ebi_discover_directly_follows_graph__as__labelled_Petri_net__to__PetriNet(UIPluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		...
		org.apache.commons.math3.fraction.BigFraction input_1 = dialog.get_parameter_org.apache.commons.math3.fraction.BigFraction(0);
...
// == command Ebi discover occurrence labelled-petri-net == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover occurrence labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiProcessTree.EfficientTree2EbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight that matches the occurrences of its label; silent transitions get a weight of 1. (input: XLog, process tree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "process tree" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_1) throws Exception {
		return Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0, input_1);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover occurrence labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiLabelledPetriNet.AcceptingPetriNet2EbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight that matches the occurrences of its label; silent transitions get a weight of 1. (input: XLog, AcceptingPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "AcceptingPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_1) throws Exception {
		return Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0, input_1);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover occurrence labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiStochasticLabelledPetriNet.StochasticLabelledPetriNet2EbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight that matches the occurrences of its label; silent transitions get a weight of 1. (input: XLog, StochasticLabelledPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "StochasticLabelledPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_1) throws Exception {
		return Ebi_discover_occurrence_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0, input_1);
	}
...
// == command Ebi discover occurrence process-tree == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_discover_occurrence_process_tree__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover occurrence process-tree", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiProcessTree.EfficientTree2EbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each leaf a weight that matches the occurrences of its label; silent leaves get a weight of 1. (input: XLog, process tree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "process tree" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0, 1 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_occurrence_process_tree__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_1) throws Exception {
		return Ebi_discover_occurrence_process_tree__as__scalable_vector_graphics__to__svg(context, input_0, input_1);
	}
...
// == command Ebi discover uniform labelled-petri-net == 
	...
	@Plugin(
		name = "Give each transition a weight of 1 in a labelled Petri net. (input: process tree; output: PetriNet)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "PetriNet" }, 
		returnTypes = { org.processmining.models.graphbased.directed.petrinet.Petrinet.class },
		parameterLabels = { "process tree" },
	...
	@Plugin(
		name = "Give each transition a weight of 1 in a labelled Petri net. (input: process tree; output: StochasticLabelledPetriNet)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "StochasticLabelledPetriNet" }, 
		returnTypes = { org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights.class },
		parameterLabels = { "process tree" },
	...
	public static com.kitfox.svg.SVGDiagram Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover uniform labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiLabelledPetriNet.AcceptingPetriNet2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight of 1 in a labelled Petri net. (input: AcceptingPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "AcceptingPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		return Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover uniform labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiProcessTree.EfficientTree2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight of 1 in a labelled Petri net. (input: process tree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "process tree" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover uniform labelled-petri-net", ".svg", new String[] {org.processmining.ebi.objects.EbiStochasticLabelledPetriNet.StochasticLabelledPetriNet2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each transition a weight of 1 in a labelled Petri net. (input: StochasticLabelledPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "StochasticLabelledPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		return Ebi_discover_uniform_labelled_petri_net__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi discover uniform process-tree == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_discover_uniform_process_tree__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover uniform process-tree", ".svg", new String[] {org.processmining.ebi.objects.EbiProcessTree.EfficientTree2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Give each leaf a weight of 1 in a process tree. (input: process tree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "process tree" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_uniform_process_tree__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_discover_uniform_process_tree__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi discover-non-stochastic flower deterministic-finite-automaton == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_discover_non_stochastic_flower_deterministic_finite_automaton__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover-non-stochastic flower deterministic-finite-automaton", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Discover a DFA that supports any trace with the activities of the log. (input: XLog; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_non_stochastic_flower_deterministic_finite_automaton__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_discover_non_stochastic_flower_deterministic_finite_automaton__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi discover-non-stochastic flower process-tree == 
	...
	public static org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree Ebi_discover_non_stochastic_flower_process_tree__as__process_tree__to__process tree(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
	...
	@Plugin(
		name = "Discover a process tree that supports any trace with the activities of the log. (input: XLog; output: process tree)",
		level = PluginLevel.PeerReviewed, 
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree prom_Ebi_discover_non_stochastic_flower_process_tree__as__process_tree__to__process tree(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_discover_non_stochastic_flower_process_tree__as__process_tree__to__process tree(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_discover_non_stochastic_flower_process_tree__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover-non-stochastic flower process-tree", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Discover a process tree that supports any trace with the activities of the log. (input: XLog; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_non_stochastic_flower_process_tree__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_discover_non_stochastic_flower_process_tree__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi discover-non-stochastic prefix-tree deterministic-finite-automaton == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_discover_non_stochastic_prefix_tree_deterministic_finite_automaton__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover-non-stochastic prefix-tree deterministic-finite-automaton", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Discover a DFA that is a prefix tree of the log. (input: XLog; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_non_stochastic_prefix_tree_deterministic_finite_automaton__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_discover_non_stochastic_prefix_tree_deterministic_finite_automaton__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi discover-non-stochastic prefix-tree process-tree == 
	...
	public static org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree Ebi_discover_non_stochastic_prefix_tree_process_tree__as__process_tree__to__process tree(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
	...
	@Plugin(
		name = "Discover a process tree that is a prefix tree of the log. (input: XLog; output: process tree)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "process tree" }, 
		returnTypes = { org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree prom_Ebi_discover_non_stochastic_prefix_tree_process_tree__as__process_tree__to__process tree(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_discover_non_stochastic_prefix_tree_process_tree__as__process_tree__to__process tree(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_discover_non_stochastic_prefix_tree_process_tree__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover-non-stochastic prefix-tree process-tree", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Discover a process tree that is a prefix tree of the log. (input: XLog; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_non_stochastic_prefix_tree_process_tree__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_discover_non_stochastic_prefix_tree_process_tree__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi information == 
	...
	@Plugin(
		name = "Show information about a file. (input: process tree; output: string)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "string" }, 
...
// == command Ebi itself graph == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_itself_graph__as__scalable_vector_graphics__to__svg(PluginContext context) throws Exception {
		String result = CallEbi.call_ebi("Ebi itself graph", ".svg", new String[] {});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Print the graph of Ebi. (input: ; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "" },
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Print the graph of Ebi. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = {  })
	public com.kitfox.svg.SVGDiagram prom_Ebi_itself_graph__as__scalable_vector_graphics__to__svg(PluginContext context) throws Exception {
		return Ebi_itself_graph__as__scalable_vector_graphics__to__svg(context);
	}
...
// == command Ebi visualise graph == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi visualise graph", ".svg", new String[] {org.processmining.ebi.objects.EbiLabelledPetriNet.AcceptingPetriNet2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Visualise a file as a graph. (input: AcceptingPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "AcceptingPetriNet" },
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Visualise a file as a graph. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		return Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi visualise graph", ".svg", new String[] {org.processmining.ebi.objects.EbiStochasticLabelledPetriNet.StochasticLabelledPetriNet2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Visualise a file as a graph. (input: StochasticLabelledPetriNet; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "StochasticLabelledPetriNet" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		return Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(context, input_0);
	}

	public static com.kitfox.svg.SVGDiagram Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi visualise graph", ".svg", new String[] {org.processmining.ebi.objects.EbiProcessTree.EfficientTree2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Visualise a file as a graph. (input: process tree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "process tree" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_visualise_graph__as__scalable_vector_graphics__to__svg(context, input_0);
	}
...
// == command Ebi visualise text == 
	...
	@Plugin(
		name = "Visualise a file as text. (input: process tree; output: string)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "string" }, 
		returnTypes = { String.class },
		parameterLabels = { "process tree" },
...
@SuppressWarnings("unused")
	...
	private static void call_every_ebi_to_java_translator(PluginContext context) throws Exception {
		...
		{
			com.kitfox.svg.SVGDiagram input = org.processmining.ebi.objects.EbiSvg.fromEbiString(context, "");
		}
		{
			org.deckfour.xes.model.XLog input = org.processmining.ebi.objects.EbiEventLog.EbiStringToXLog(context, "");
			org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input);

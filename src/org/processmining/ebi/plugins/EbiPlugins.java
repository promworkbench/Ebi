...
// == command Ebi analyse-non-stochastic has-traces == 

	public static boolean Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi analyse-non-stochastic has-traces", ".bool", new String[] {org.processmining.ebi.objects.EbiProcessTree.EfficientTree2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiBoolean.fromEbiString(context, result);
	}

	@Plugin(
		name = "Compute whether the model has traces. (input: process tree; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		...
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Compute whether the initial marking is part of a livelock, that is, whether it is impossible to reach a final state. 'true' means that the initial state is part of a livelock, 'false' means that the initial state is not part of a livelock. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(PluginContext context, org.processmining.plugins.InductiveMiner.efficienttree.EfficientTree input_0) throws Exception {
		return Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi analyse-non-stochastic has-traces", ".bool", new String[] {org.processmining.ebi.objects.EbiLabelledPetriNet.AcceptingPetriNet2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiBoolean.fromEbiString(context, result);
	}

	@Plugin(
		name = "Compute whether the model has traces. (input: AcceptingPetriNet; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(PluginContext context, org.processmining.acceptingpetrinet.models.AcceptingPetriNet input_0) throws Exception {
		return Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi analyse-non-stochastic has-traces", ".bool", new String[] {org.processmining.ebi.objects.EbiStochasticLabelledPetriNet.StochasticLabelledPetriNet2EbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiBoolean.fromEbiString(context, result);
	}

	@Plugin(
		name = "Compute whether the model has traces. (input: StochasticLabelledPetriNet; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(PluginContext context, org.processmining.stochasticlabelledpetrinets.StochasticLabelledPetriNetSimpleWeights input_0) throws Exception {
		return Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(context, input_0);
	}

	public static boolean Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		String result = CallEbi.call_ebi("Ebi analyse-non-stochastic has-traces", ".bool", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0)});
		return org.processmining.ebi.objects.EbiBoolean.fromEbiString(context, result);
	}

	@Plugin(
		name = "Compute whether the model has traces. (input: XLog; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public boolean prom_Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(PluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		return Ebi_analyse_non_stochastic_has_traces__as__boolean__to__bool(context, input_0);
	}
...
// == command Ebi analyse-non-stochastic infinitely-many-traces == 
	...
	@Plugin(
		...
		userAccessible = true,
		categories = { PluginCategory.Discovery, PluginCategory.Analytics, PluginCategory.ConformanceChecking },
		help = "Compute whether the model has infinitely many traces. (calls Ebi)"
	)
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })

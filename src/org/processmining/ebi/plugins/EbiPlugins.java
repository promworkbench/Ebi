...
// == command Ebi conformance earth-movers-sample == 
	...
	@Plugin(
		name = "Compute Earth mover's stochastic conformance, which is 1 - Wasserstein distance, where one or both of the inputs needs to be sampled. (input: XLog, XLog; output: fraction)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "fraction" }, 
		returnTypes = { org.apache.commons.math3.fraction.BigFraction.class },
		parameterLabels = { "XLog", "XLog" },
	...
	public org.apache.commons.math3.fraction.BigFraction prom_Ebi_conformance_earth_movers_sample__as__fraction__to__fraction(UIPluginContext context, org.deckfour.xes.model.XLog input_0, org.deckfour.xes.model.XLog input_1) throws Exception {
		EbiDialog dialog = new EbiDialog();
		dialog.add_input(org.processmining.ebi.objects.EbiInteger.create_input_panel("Number of traces to sample."));
		InteractionResult result = context.showWizard("Compute Earth mover's stochastic conformance, which is 1 - Wasserstein distance, where one or both of the inputs needs to be sampled.", true, true, dialog);
	...
	@Plugin(
		name = "Compute Earth mover's stochastic conformance, which is 1 - Wasserstein distance, where one or both of the inputs needs to be sampled. (input: XLog, StochasticLabelledPetriNet; output: fraction)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "fraction" }, 
		returnTypes = { org.apache.commons.math3.fraction.BigFraction.class },
		parameterLabels = { "XLog", "StochasticLabelledPetriNet" },
	...
	@Plugin(
		name = "Compute Earth mover's stochastic conformance, which is 1 - Wasserstein distance, where one or both of the inputs needs to be sampled. (input: StochasticLabelledPetriNet, XLog; output: fraction)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "fraction" }, 
		returnTypes = { org.apache.commons.math3.fraction.BigFraction.class },
		parameterLabels = { "StochasticLabelledPetriNet", "XLog" },
	...
	@Plugin(
		name = "Compute Earth mover's stochastic conformance, which is 1 - Wasserstein distance, where one or both of the inputs needs to be sampled. (input: StochasticLabelledPetriNet, StochasticLabelledPetriNet; output: fraction)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "fraction" }, 
		returnTypes = { org.apache.commons.math3.fraction.BigFraction.class },
		parameterLabels = { "StochasticLabelledPetriNet", "StochasticLabelledPetriNet" },

...
// == command Ebi analyse-non-stochastic any-traces == 
	...
	@Plugin(
		name = "Compute whether the model has any traces. (input: ProcessTree; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
...
// == command Ebi analyse-non-stochastic bounded == 
	...
	@Plugin(
		name = "Compute whether the model has a bounded state space. (input: ProcessTree; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "ProcessTree" },
...
// == command Ebi analyse-non-stochastic infinitely-many-traces == 
	...
	@Plugin(
		name = "Compute whether the model has infinitely many traces. (input: ProcessTree; output: bool)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "bool" }, 
		returnTypes = { boolean.class },
		parameterLabels = { "ProcessTree" },
...
// == command Ebi convert labelled-petri-net == 
	...
	@Plugin(
		name = "Convert an object to a labelled Petri net. (input: ProcessTree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "ProcessTree" },
...
// == command Ebi discover alignments == 
	...
	@Plugin(
		name = "Give each transition a weight that matches the aligned occurrences of its label. (input: XLog, ProcessTree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "ProcessTree" },
...
// == command Ebi discover directly-follows-graph == 
	...
	public static com.kitfox.svg.SVGDiagram Ebi_discover_directly_follows_graph__as__scalable_vector_graphics__to__svg(PluginContext context, org.deckfour.xes.model.XLog input_0, org.apache.commons.math3.fraction.BigFraction input_1) throws Exception {
		String result = CallEbi.call_ebi("Ebi discover directly-follows-graph", ".svg", new String[] {org.processmining.ebi.objects.EbiEventLog.XLogToEbiString(context, input_0), org.processmining.ebi.objects.EbiFraction.toEbiString(context, input_1)});
		return org.processmining.ebi.objects.EbiSvg.fromEbiString(context, result);
	}

	@Plugin(
		name = "Discover a directly follows graph. (input: XLog; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog" },
	...
	@UITopiaVariant(affiliation = IMMiningDialog.affiliation, author = IMMiningDialog.author, email = IMMiningDialog.email)
	@PluginVariant(variantLabel = "Call Ebi", requiredParameterLabels = { 0 })
	public com.kitfox.svg.SVGDiagram prom_Ebi_discover_directly_follows_graph__as__scalable_vector_graphics__to__svg(UIPluginContext context, org.deckfour.xes.model.XLog input_0) throws Exception {
		EbiDialog dialog = new EbiDialog();
		dialog.add_input(org.processmining.ebi.objects.EbiFraction.create_input_panel("The minimum fraction of traces that should fit the resulting model."));
		InteractionResult result = context.showWizard("Discover a directly follows graph.", true, true, dialog);
		...
		org.apache.commons.math3.fraction.BigFraction input_1 = dialog.get_parameter_org_apache_commons_math3_fraction_BigFraction(0);
		return Ebi_discover_directly_follows_graph__as__scalable_vector_graphics__to__svg(context, input_0, input_1);
	}
...
// == command Ebi discover occurrence labelled-petri-net == 
	...
	@Plugin(
		name = "Give each transition a weight that matches the occurrences of its label; silent transitions get a weight of 1. (input: XLog, ProcessTree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "ProcessTree" },
...
// == command Ebi discover occurrence process-tree == 
	...
	@Plugin(
		name = "Give each leaf a weight that matches the occurrences of its label; silent leaves get a weight of 1. (input: XLog, ProcessTree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "XLog", "ProcessTree" },
...
// == command Ebi discover uniform labelled-petri-net == 
	...
	@Plugin(
		name = "Give each transition a weight of 1 in a labelled Petri net. (input: ProcessTree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "ProcessTree" },
...
// == command Ebi discover uniform process-tree == 
	...
	@Plugin(
		name = "Give each leaf a weight of 1 in a process tree. (input: ProcessTree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "ProcessTree" },
...
// == command Ebi visualise graph == 
	...
	@Plugin(
		name = "Visualise a file as a graph. (input: ProcessTree; output: svg)",
		level = PluginLevel.PeerReviewed, 
		returnLabels = { "svg" }, 
		returnTypes = { com.kitfox.svg.SVGDiagram.class },
		parameterLabels = { "ProcessTree" },
